...
import static io.restassured.RestAssured.given; //static method
...
public class GoRestSteps {
	...
	public void i_provide_the_request_data() {
		...
		request = given()
				...
				.header("Authorization", "Bearer xu7l-rGzp9KnX1yMUv8DF8Il-6x-uZfpeM0g");
	...
	@When("I make a call to the albums API")
	public void i_make_a_call_to_the_albums_API() {
		int albumId = 4;
